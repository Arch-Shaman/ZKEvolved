  ...
  weaponDefs             = {
	...
	MISSILE_AG = {
		...
		customParams        	  = {
			...
			spawndist = 350, -- at what distance should we spawn the projectile(s)? REQUIRED.
    ...
    MISSILE_AA = {
		...
		customParams        	  = {
			...
			--spreadradius = 4, -- used in clusters. OPTIONAL. Default: 100.
			--clustervec = "evenxz", -- accepted values: randomx, randomy, randomz, randomxy, randomxz, randomyz, random. OPTIONAL. default: random.
...
return lowerkeys({ proliferator = unitDef })
